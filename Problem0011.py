...
for i in range (0,17):
	for j in range (0,17):
		...
		if product > max:
			max = product
			print ("diagonal\\:  " + str(i) + "  " + str(j) + "  " + str(max) + "  " + str(A[i][j]) + "  " +   str(A[i + 1][j+1]) + "  " +  str(A[i + 2][j+2]) + "  " +  str(A[i + 3][j+3]))
...
for i in range (0,20):
	for j in range (0,17):
		...
		if product > max:
			max = product
			print ("waagrecht:  " + str(i) + "  " + str(j) + "  " + str(max))
...
for i in range (0,17):
	for j in range (0,20):
		...
		if product > max:
			max = product
			print ("senkrecht:  " + str(i) + "  " + str(j) + "  " + str(max))